...
const char *dbfile_dir = "/mnt/c/Prajan/Sem-2/DBI/DBI/P1/bin/"; // dir where binary heap files should be stored
const char *tpch_dir ="/mnt/c/Prajan/Sem-2/DBI/DBI/P1/tpch-dbgen/"; // dir where dbgen tpch files (extension *.tbl) can be found
